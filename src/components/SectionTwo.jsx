  ...
  return (
      <section className='m-h-[25vh]  my-20 py-5'>
          <div className="section bg-[#eaded7] h-[400px] flex">
              ...
              Remember, this is just a conceptual idea, and the design should ultimately reflect your personal style, preferences,  <br/> and the occasion for which you intend to wear the Hanfu. Working with a skilled tailor or designer can help bring your custom Hanfu design to life.
              </p>
          </div>
          </div>
          <div className="boxContainer flex justify-evenly flex-wrap gap-4 lg:gap-2 relative top-[-150px]">
              <div className="box bg-[#c5a491] h-[330px] rounded-md flex flex-col items-center justify-center gap-6">
                  ...
                  <div className="info w-[90%] lg:w-[400px] text-center flex flex-col items-center">
                      ...
                      Documenting historical clothing styles, patterns, and techniques.
                      </p>
                  </div>
              </div>
